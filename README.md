...
Implementacja dynamicznego odświeżania zawartości combo-boxa i tytułu książki w recenzjach.

Poprawa architektury projektu, aby wyeliminować konieczność ręcznego odświeżania niektórych komponentów.

Wdrożenie bardziej zaawansowanego systemu uwierzytelniania użytkowników.

Autorzy

Imię Nazwisko – Twórca projektu
